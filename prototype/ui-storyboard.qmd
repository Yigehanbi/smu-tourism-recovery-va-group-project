...
1. Cluster quality strip with silhouette, selected `k`, and window summary
2. Cluster insight card with lead pattern and China placement narrative
3. Representative pattern plot
4. Cluster diagnostic table
5. Recovery position map
6. Cluster summary table
7. Membership table with assignment download
8. Recovery metrics table
:::
