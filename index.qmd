...
This project studies tourism recovery as a comparative time-series problem. The website presents the analytical story, the merged user guide explains the full workflow across all three modules, and the deployed Shiny app turns that structure into an interactive workspace for market structure, recovery pattern comparison, and forward projection.

::: {.home-actions}
[Open Live Shiny App](`r shiny_app_url`){target="_blank" .btn-home-primary}
[Read Merged User Guide](./user-guide.html){.btn-home-secondary}
...
::: {.home-hero-note}
Start with market structure, continue into recovery clustering, and finish with forecasting. The merged user guide follows that same order and the homepage button opens the deployed app directly.
:::
:::
...
<strong>Merged walkthrough across visual analysis, clustering, and forecasting</strong>
</a>
